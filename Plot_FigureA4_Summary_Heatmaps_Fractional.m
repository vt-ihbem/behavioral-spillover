...
files = {'Data_mu0_tauR100_Fractional_long'};
...
if saveplot==1
    % png figures
    fileout5 = strcat('Figures/Heatmap_Fractional_','Ithres.png');
    saveas(f5,fileout5,'png')
    fileout6 = strcat('Figures/Heatmap_Fractional_','BoverA_time.png');
    saveas(f6,fileout6,'png')
    fileout7 = strcat('Figures/Heatmap_Fractional_','BoverA.png');
    saveas(f7,fileout7,'png')
    fileout8 = strcat('Figures/Heatmap_Fractional_','AoverB.png');
    saveas(f8,fileout8,'png')
    % tif figures
    fileout5a = strcat('Figures/tiff/Heatmap_Fractional_','Ithres.tif');
    saveas(f5,fileout5a,'tif')
    fileout6a = strcat('Figures/tiff/Heatmap_Fractional_','BoverA_time.tif');
    saveas(f6,fileout6a,'tif')
    fileout7a = strcat('Figures/tiff/Heatmap_Fractional_','BoverA.tif');
    saveas(f7,fileout7a,'tif')
    fileout8a = strcat('Figures/tiff/Heatmap_Fractional_','AoverB.tif');
